...
use common\models\StudentParentSearch;
...
class StudentParentController extends Controller
{
    ...
    /**
     * Updates an existing StudentParent model.
    ...
    /**
     * Deletes an existing StudentParent model.
    ...
    /**
     * Finds the StudentParent model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return StudentParent the loaded model
